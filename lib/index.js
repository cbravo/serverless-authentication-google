...
var GoogleProvider = function (_Provider) {
  ...
  _createClass(GoogleProvider, [{
    ...
    value: function signinHandler(_ref, callback) {
      ...
      var variable_options = { scope: scope, state: state, access_type: access_type };
      // Not sure how to NOT-ADD prompt if its undefined...
      if (prompt) {
        variable_options = Object.assign(variable_options, { prompt: prompt });
      }
      var options = Object.assign(variable_options, { signin_uri: 'https://accounts.google.com/o/oauth2/v2/auth', response_type: 'code' });

      _get(GoogleProvider.prototype.__proto__ || Object.getPrototypeOf(GoogleProvider.prototype), 'signin', this).call(this, options, callback);
    }
  }, {
    key: 'callbackHandler',
    value: function callbackHandler(event, callback) {
      ...
      _get(GoogleProvider.prototype.__proto__ || Object.getPrototypeOf(GoogleProvider.prototype), 'callback', this).call(this, event, options, { authorization: { grant_type: 'authorization_code' } }, callback);
    }
  }]);
